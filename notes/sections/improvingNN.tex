...
\begin{figure}[h]
  \includegraphics[scale=1]{testerror.png}
\end{figure}
...
\subsection{Model Selection}
  ...
  % \lstinputlisting[language=octave, caption=Octave implementation for sections of Neural Networks]{4.NN Learning.m}
...
\section{Bias vs. Variance}
  ...
  % \lstinputlisting[language=Octave]{5.bias-variance.m}  
